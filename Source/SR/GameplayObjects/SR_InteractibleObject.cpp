...
ASR_InteractibleObject::ASR_InteractibleObject() {
  ...
  TriggerSphere =
      CreateDefaultSubobject<USphereComponent>(TEXT("TriggerSphere"));
...
void ASR_InteractibleObject::BeginPlay() {
  ...
  TriggerSphere->OnComponentBeginOverlap.AddDynamic(
      this, &ASR_InteractibleObject::OnOverlapBegin);
  TriggerSphere->OnComponentEndOverlap.AddDynamic(
      this, &ASR_InteractibleObject::OnOverlapEnd);
}

void ASR_InteractibleObject::OnOverlapBegin(UPrimitiveComponent *OverlappedComp,
                                            AActor *OtherActor,
                                            UPrimitiveComponent *OtherComp,
                                            int32 OtherBodyIndex,
                                            bool bFromSweep,
                                            const FHitResult &SweepResult) {
  if (USR_EnergyComponent *EnergyComp =
          OtherActor->FindComponentByClass<USR_EnergyComponent>()) {
...
void ASR_InteractibleObject::OnOverlapEnd(UPrimitiveComponent *OverlappedComp,
                                          AActor *OtherActor,
                                          UPrimitiveComponent *OtherComp,
                                          int32 OtherBodyIndex) {}