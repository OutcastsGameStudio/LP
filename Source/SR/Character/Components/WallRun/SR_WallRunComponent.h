...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Wall Run", meta = (ToolTip = "Wall run deceleration ratio"))
...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Wall Run | Camera",
			  meta = (ClampMin = "0.0", ClampMax = "50.0", ToolTip = "Camera roll rotation speed during wall run"))
	float CameraRollSpeed = 20.0f;

	UPROPERTY(EditAnywhere, Category = "Wall Run | Camera",
			  meta = (ClampMin = "0.0", ClampMax = "30.0", ToolTip = "Camera offset angle from the run direction"))
