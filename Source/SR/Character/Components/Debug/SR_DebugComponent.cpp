...
{
	Super::BeginPlay();
	CharacterMovementComponent = Cast<USR_CharacterMovementComponent>(OwnerCharacter->GetCharacterMovement());
	// LoadDataTable();
	//  ...
}
...
float USR_DebugComponent::GetLedgeGrabHeight() { return OwnerCharacter->GetLedgeGrabHeight(); }
...
float USR_DebugComponent::GetClimbUpSpeed() { return OwnerCharacter->GetClimbUpSpeed(); }
